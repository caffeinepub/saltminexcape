...
function drawPlayer(ctx, p, saltMeter, hasAxe, axeTimer = 600, dyingTimer = 0, hasGun = false, gunTimer = 600) {
  ...
  if (state === "run") {
    ...
    if (angry) {
      ...
      ctx.fillRect(
        22,
        2 + (Math.sin(Date.now() * 4e-3) * 0.5 + 0.5) * 2,
        2,
        3
      );
      ctx.fillRect(
        22,
        4 + (Math.sin(Date.now() * 4e-3) * 0.5 + 0.5) * 2,
        3,
        2
      );
      ctx.globalAlpha = hitTimer > 0 && Math.floor(hitTimer / 4) % 2 === 0 ? 0.3 : 1;
    ...
    const idleBob = state === "idle" ? Math.sin(Date.now() * 2e-3) * 1 : 0;
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              hudData.hasAxe && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", alignItems: "center", gap: 3 }, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#ffd700", fontSize: 9 }, children: "⛏" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    style: {
                    ...
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "div",
                      {
                        style: {
                          ...
                          height: "100%",
                          background: hudData.axeTimer < 120 ? Math.floor(Date.now() / 200) % 2 === 0 ? "#ffd700" : "#ff4444" : "#ffd700"
                        }
                      }
                    )
                  }
              ...
              hudData.hasGun && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", alignItems: "center", gap: 3 }, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#00ff88", fontSize: 9 }, children: "🔫" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    style: {
                    ...
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "div",
                      {
                        style: {
                          ...
                          height: "100%",
                          background: hudData.gunTimer < 100 ? Math.floor(Date.now() / 200) % 2 === 0 ? "#00ff88" : "#ff4444" : "#00ff88"
                        }
                      }
                    )
                  }
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", flexDirection: "column", gap: 8 }, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "button",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { "aria-hidden": true, children: hasGunDisplay && !hasAxeDisplay ? "🔫" : "⛏" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { "aria-hidden": true, children: "B" })
                    ]
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
