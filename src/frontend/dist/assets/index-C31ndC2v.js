...
const ICP_PRICES = [2, 3, 5, 7, 10, 13, 17, 20];
...
function updateGame(gs, _dt) {
  ...
  if (gs.bearThrowTimer >= bearThrowInterval) {
    ...
    const hw = hType === "cart" ? 32 : hType === "candle" ? 18 : hType === "boulder" ? 20 : hType === "chest" ? 22 : hType === "pickaxe" ? 20 : hType === "saltbag" ? 20 : hType === "barrel" ? 16 : 14;
    const hh = hType === "cart" ? 22 : hType === "candle" ? 24 : hType === "boulder" ? 20 : hType === "chest" ? 18 : hType === "pickaxe" ? 20 : hType === "saltbag" ? 22 : hType === "barrel" ? 18 : 18;
...
function drawKoolAid(ctx, x, y, frame) {
...
function drawVictoryScreen(ctx, score, lives, frame) {
  ...
  const finalValue = Math.floor(150 * 1e4 * bonus);
  ctx.fillStyle = "#4fc3f7";
  ctx.font = "bold 14px monospace";
  ctx.fillText(
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { color: "#4fc3f7", fontSize: 10, minWidth: 60 }, children: [
                "ICP $",
                icpPrice.toFixed(2)
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { color: "#81c784", fontSize: 10, minWidth: 70 }, children: [
                "$",
                portfolio.toLocaleString()
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { color: "#ffffff", fontSize: 10, minWidth: 40 }, children: hudData.score }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", alignItems: "center", gap: 3 }, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { "aria-hidden": "true", width: "10", height: "18", viewBox: "0 0 16 22", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { x: "4", y: "0", width: "8", height: "5", fill: "#ff5722" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { x: "3", y: "6", width: "10", height: "13", fill: "#00bcd4" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { x: "2", y: "8", width: "12", height: "9", fill: "#00bcd4" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { x: "4", y: "4", width: "8", height: "5", fill: "#00bcd4" }),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { style: { color: "#00bcd4", fontSize: 10 }, children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "button",
                  {
                    ...
                    style: {
                      width: 60,
                      height: 44,
                      background: hasAxeDisplay ? "rgba(255,200,50,0.25)" : "rgba(255,255,255,0.1)",
