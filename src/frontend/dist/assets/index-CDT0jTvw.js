...
function drawPlayer(ctx, p, saltMeter, hasAxe, axeTimer = 600, dyingTimer = 0) {
...
function drawBear(ctx, bx, by, armRaise, throwAnim = 0, walkFrame = 0) {
  ctx.save();
  ctx.translate(bx, by);
...
function drawPlatform(ctx, x, y, w, h, tint) {
