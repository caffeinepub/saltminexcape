...
const ICP_PRICES = [15, 22, 31, 45, 62, 85, 110, 150];
...
function updateGame(gs, _dt) {
  ...
  if (gs.bearThrowTimer >= bearThrowInterval) {
    ...
    const throwVx = throwDir * (1.2 + Math.random() * 1 + gs.level * 0.1);
    gs.hazards.push({
      id: gs.nextHazardId++,
      type: hType,
      x: bearCx - hw / 2,
      ...
      for (const plat of gs.currentPlatforms) {
        if (h.x + h.w > plat.x && h.x < plat.x + plat.w) {
          ...
          if (h.vy >= 0 && prevB <= plat.y + 2 && h.y + h.h >= plat.y) {
            ...
            h.onGround = true;
            if (!h.wasOnGround) {
              const rollSpeed = Math.max(Math.abs(h.vx), 2 + gs.level * 0.15);
...
function drawPlayer(ctx, p, saltMeter, hasAxe) {
...
function drawBear(ctx, bx, by, armRaise) {
  ctx.save();
  ctx.translate(bx, by);
...
function drawBackground(ctx, _level, frame) {
...
function CssArrow({ dir }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "svg",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("title", { children: dir }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d, fill: "rgba(255,255,255,0.9)" })
      ]
    }
  );
}
function Game() {
  ...
  const toggleMusicMute = reactExports.useCallback(() => {
    setMusicMuted((prev) => {
      const next = !prev;
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    ...
                    children: TOUCH_BTNS.filter((b) => !b.right).map((btn) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "button",
                      {
                        type: "button",
                        ...
                        children: /* @__PURE__ */ jsxRuntimeExports.jsx(CssArrow, { dir: btn.dir })
                      },
                      btn.id
                    ))
                  }
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "button",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { "aria-hidden": true, style: { fontSize: 24, lineHeight: 1 }, children: "⛏️" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { "aria-hidden": true, style: { fontSize: 10, letterSpacing: 1 }, children: "B" })
                    ]
                  }
                )
              ]
              ...
              "button",
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "svg",
                  {
                    ...
                    "aria-hidden": "true",
                    role: "presentation",
                    children: musicMuted ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "path",
                        {
